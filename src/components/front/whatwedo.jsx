    ...
    <div className='bg-gray-100'>
      <div className='relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
        ...
        <div className='relative grid gap-5 sm:grid-cols-2 lg:grid-cols-4'>
          <div className='flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-fill rounded shadow-xl group hover:shadow-2xl'>
            <div className='p-5'>
              ...
              <p className='text-sm leading-5 text-inverted'>
