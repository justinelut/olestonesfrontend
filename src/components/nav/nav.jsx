            ...
            <div className='flex items-center justify-between py-3 mr-2 md:py-5 md:block'>
              <Link to='/'>
                <h1 className='font-semibold text-base'>
                  Ole Stones Builders & Logistics
                </h1>
              </Link>
              <div className='md:hidden'>
                <button
                  className='p-2 text-charcoal rounded-md outline-none focus:border-[#eab308] focus:border'
                  onClick={() => setNavbar(!navbar)}>
                  {navbar ? (
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      className='w-6 h-6 text-[#2ea3f2]'
                      viewBox='0 0 20 20'
                      fill='currentColor'>
                      <path
                        fillRule='evenodd'
            ...
            <div
              ...
              <div className='mt-6 mb-3 md:hidden lg:hidden xl:hidden'>
                {isAuthenticated() ? (
                  <button
                    onClick={signOut}
                    className='tracking-wide text-center rounded-md border-2 border-[#eab308] px-8 mx-2 py-2 text-base font-medium text-charcoal transition hover:bg-charcoal hover:text-white focus:outline-none focus:ring'>
                    Logout
                  </button>
                ) : (
                  <>
                    <Link
                      to='/login'
                      className='text-center rounded-md border-2 border-[#eab308] px-8 mx-2 py-2 text-base font-medium text-charcoal transition hover:bg-charcoal hover:text-white focus:outline-none focus:ring'>
                      Login
                    </Link>
                    <Link
                      to='/signup'
