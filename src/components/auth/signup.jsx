...
import Error from '../responseMessages/Error';
...
export default function Signup() {
  ...
  const onSubmit = async (data) => {
    const results = await sender('/api/users/', {
    ...
    if (results && results.message) {
      setSuccMessage('Account creation was successful, Redirecting...');
      setTimeout(() => {
        if (redirect) {
    ...
    if (results) {
      if (results.data.errors[0]) {
        setErrMessage(results.data.errors[0].data[0].message);
      }
    }
  };
      ...
      <div className='lg:grid lg:min-h-screen lg:grid-cols-12'>
        <section className='relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6'>
          ...
          <div className='hidden lg:relative lg:block lg:p-12'>
            ...
            <h2 className='mt-6 text-2xl text-white font-bold sm:text-3xl md:text-4xl'>
              Welcome to Ole Stones Builders & Logistics
            </h2>
            <p className='mt-4 leading-relaxed text-white'>
              Sign Up today and get access access to our services
            </p>
          </div>
        </section>
            ...
            <form
              ...
              <div className='col-span-6'>
                <p className='text-base'>
                  ...
                  <Link
                    to='/ke/terms-of-service'
                    className='text-gray-900 underline'>
                    terms and conditions &nbsp;
                  </Link>
                  and &nbsp;
                  <Link
                    to='/ke/privacy-policy'
                    className='text-gray-900 underline'>
                    privacy policy
                  </Link>
                  .
